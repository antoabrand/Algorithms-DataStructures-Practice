...
public class LinkedList<T extends Comparable<T>> implements IList<T> {
  ...
  // only use if we need to implement this then fine - otherwise if we are wanting to insert
  ...
  // O(n) complexity - since we must traverse entire list until we hit end ->getNextNode returns
  // null
